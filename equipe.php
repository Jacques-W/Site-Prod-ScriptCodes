    		...
    		<section class="container">
    			<div class="row">
    				...
    				<div class="col-md-4 text-light">
    					<p><span style="font-size: 1.5em; color: Dodgerblue;"><i class="fab fa-facebook"></i></span><a href="https://facebook.com/ScriCodes-106267850925400/" target="_blank">ScriptCodes</a>
    				</div>
    			</div>
    		</section>
    	</footer>
