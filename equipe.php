    		...
    		<section class="container">
    			<div class="row">
    				<div class="col-md-12 text-center text-light">
    					<p>©️copyright 2020 - Tous droits r&eacute;serv&eacute;s &agrave; ScriptCodes - Propuls&eacute; par ScriptCodes</p>
    				</div>
    				<div class="col-md-4 text-light">
    					<p><span id="logoFaceBook"><i class="fab fa-facebook"></i></span><a href="https://facebook.com/ScriCodes-106267850925400/" target="_blank">ScriptCodes</a>
    				</div>
                    <div class="col-md-4 text-light">
                        <p><span id="logoTwitter" class="fab fa-twitter"></span><a href="https:/twitter.com/ScriCodes" target="_blank"> ScriptCodes</a></p>
                    </div>
    			</div>
    		</section>
    	</footer>
