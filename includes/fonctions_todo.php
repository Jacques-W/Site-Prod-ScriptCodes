...
$prepaRequete = $db->prepare('insert into todo(nom_auteur, prenom_auteur, client, tache, date_tache, priorite) values("'.$nomAuteur.'", "'.$prenomAuteur.'", "'.$client.'", "'.$tache.'", "'.$dateTache.'", "'.$priorite.'")');
